...
export declare class ConnectorError extends Error {
    ...
    constructor(message: string, code: string, retryable: boolean, cause?: Error | undefined);
}
 ...
 */
export declare abstract class BaseConnector<TConfig, TEntity extends SemanticEntity = SemanticEntity> {
